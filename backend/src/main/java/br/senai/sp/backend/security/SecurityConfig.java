...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception {
		...
		.authorizeRequests()
			...
			.antMatchers(HttpMethod.GET, "/portfolios/{id}**").permitAll()	
//			.antMatchers(HttpMethod.OPTIONS, "/portfolios/{id}**").permitAll()
			.antMatchers(HttpMethod.PUT, "/agendas/{id}**").permitAll()	
